...
namespace FlickrViewer
{
   public partial class FlickrViewerForm : Form
   {
      ...
      // http://www.flickr.com/services/apps/create/apply
       private const string KEY = "a6f4e8b844a459cdf394c679b6cf9342";
     ...
     Task<string> flickrTask = null;// Task<string> that queries Flickr
      ...
      private async void searchButton_Click( object sender, EventArgs e )
      {
        ...
        //privacy_filter=1. Use the inputTextBox.Text.Replace(" ", ",") for tag.
         var flickrURL = string.Format("http://flickr.com/services/rest/?method=flickr.photos.search&api_key={0}&tags={1}&tag_mode=all&per_page=500&privacy_filter=1", KEY, inputTextBox.Text.Replace(" ", ","));
